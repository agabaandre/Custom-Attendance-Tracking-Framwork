...
<div class="nav-tabs-custom">
             <ul class="nav nav-tabs">
                  ...
                  <li class="active"><a href="dashboard.php?action=update_passport">Update Passport Photo</a></li>					  
                 </ul>
				</div>
                               
                <div class="box-header with-border">
                  <h5 class="box-title">Update Passport Photo</h5>
...
<form action="" method="post" enctype="multipart/form-data">
                ...
                <div id="">
					...
					<br/>
                <button  class="btn btn-primary" name="submit" type="submit" ><span class="glyphicon glyphicon-edit"></span>Update</button>
</form>
</div>
<?php
...
$sql = ("UPDATE `attendance_tracking`.`passports` SET `Passport_photo`='{$imgData}',`Name`='{$_FILES['userfile']['name']}',`Size`='{$_FILES['userfile']['size']}' WHERE `passports`.`emp_id`='$emp_id';");
